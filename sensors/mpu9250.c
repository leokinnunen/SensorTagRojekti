...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	int16_t first_nx, second_nx;
	second_nx = (int16_t)rawData[0] << 8;
	first_nx = (int16_t)rawData[1];
	int16_t nx = first_nx + second_nx;

	int16_t first_ny, second_ny;
	second_ny = (int16_t)rawData[2] << 8;
	first_ny = (int16_t)rawData[3];
	int16_t ny = first_ny + second_ny;

	int16_t first_nz, second_nz;
	second_nz = (int16_t)rawData[4] << 8;
	first_nz = (int16_t)rawData[5];
	int16_t nz = first_nz + second_nz;

	int16_t first_mx, second_mx;
	second_mx = (int16_t)rawData[8] << 8;
	first_mx = (int16_t)rawData[9];
	int16_t mx = first_mx + second_mx;

	int16_t first_my, second_my;
	second_my = (int16_t)rawData[10] << 8;
	first_my = (int16_t)rawData[11];
	int16_t my = first_my + second_my;

	int16_t first_mz, second_mz;
	second_mz = (int16_t)rawData[12] << 8;
	first_mz = (int16_t)rawData[13];
	int16_t mz = first_mz + second_mz;
